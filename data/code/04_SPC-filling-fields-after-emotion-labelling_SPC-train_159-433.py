...
input_directory_path = f"/home/ubuntu/conversation-data/dataset-02-SPC/Synthetic-Persona-Chat/data/04_emotion-labeled_data/{folder_name}"
output_directory_path = f"/home/ubuntu/conversation-data/dataset-02-SPC/Synthetic-Persona-Chat/data/04_emotion-labeled_data/{folder_name}"
